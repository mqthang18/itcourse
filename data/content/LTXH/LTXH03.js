const LTXH03 = {
    ...
    LTXH04: {
        title: 'Tính hường: Mạng truyền tin với 1 kênh truyền',
        index: [
            ['Nội dung', 'LTXH041', `
            <ul>
    ...
    LTXH07: {
        title: '3 loại mạng theo lưu lượng khách hàng lưu thông',
        index: [
            ['Nội dung', 'LTXH071', `
            <ul>
    ...
    LTXH08: {
        title: 'Đầu vào của mô hình: Khách hàng',
        index: [
            ['Nội dung', 'LTXH081', `<ul>
            <li>Ký hiệu theo mô hình mạng
                <br>
    ...
    LTXH09: {
        title: 'Đầu vào của mô hình: Trung tâm phục vụ',
        index: [
            ['Nội dung', 'LTXH091', `
            <ul>
    ...
    LTXH10: {
        title: 'Tình huống: Máy tính với hai thiết bị ngoại vi',
        index: [
            [
                'Nội dung', 'LTXH101', `
                <ul>
